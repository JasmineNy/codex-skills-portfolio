...
> Skill ID: `investment-checklist` · Category: AI Berkshire：投资研究

## 功能说明

在买入前逐项检查生意质量、护城河、管理层、财务、估值和潜在永久损失。
...
2. 在对话中使用 `$investment-checklist` 显式调用，或让 Codex 根据 description 自动匹配。
