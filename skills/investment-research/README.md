...
> Skill ID: `investment-research` · Category: AI Berkshire：投资研究

## 功能说明

用巴菲特、芒格、段永平和李录的综合框架研究生意、财务、竞争力、管理层与风险。
...
2. 在对话中使用 `$investment-research` 显式调用，或让 Codex 根据 description 自动匹配。
