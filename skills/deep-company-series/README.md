...
> Skill ID: `deep-company-series` · Category: AI Berkshire：投资研究

## 功能说明

把一家公司拆成 3–8 篇相互衔接的深度文章，兼顾研究完整性与公众可读性。
...
2. 在对话中使用 `$deep-company-series` 显式调用，或让 Codex 根据 description 自动匹配。
